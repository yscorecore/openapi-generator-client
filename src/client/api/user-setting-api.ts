...
export class UserSettingApi {
     ...
     * @param string key 
     */
    public apiUserSettingKeyDelete(key: string | null): Promise<void> {
        return send({
     ...
     */
    public apiUserSettingPost(keepstring?: boolean, stringObjectKeyValuePair?: StringObjectKeyValuePair): Promise<void> {
        return send({
            url: '/api/UserSetting',
            method: 'POST',
            params: {
